...
<main>
  <div class="relative">
      ...
      <div class="navbar" v-if="all">
        <div>
          <b-button  class="w-100" variant="outline-secondary" v-for="(question, route) in questions.all" :to="`/question/${route}`" >
      ...
      <div class="navbar" v-if="cphds">
        <div>
          <b-button  class="w-100" variant="outline-secondary" v-for="(question, route) in questions.cphds" :to="`/question/${route}`" >
            <span :class="getFilterClass(question.filter)">{{ question.filter }}</span> {{ question.title }}
          </b-button>
        </div>
      ...
      <div class="navbar" v-if="other">
        <div>
          <b-button  class="w-100" variant="outline-secondary" v-for="(question, route) in questions.other" :to="`/question/${route}`" >
            <span :class="getFilterClass(question.filter)">{{ question.filter }}</span> {{ question.title }}
          </b-button>
        </div>
      ...
      <div class="navbar" v-if="prof">
        <div>
          <b-button  class="w-100" variant="outline-secondary" v-for="(question, route) in questions.prof" :to="`/question/${route}`" >
            <span :class="getFilterClass(question.filter)">{{ question.filter }}</span> {{ question.title }}
          </b-button>
        </div>
        ...
        <div id="side2" class="main">
          <div v-if="homepage" class="choosequestion">
            Choose a question
          </div>

          <div v-if="questionnew" class="questionnew">
          ...
          <div v-if="questionpost" class="post-question-card">
            <b-card title="Post a Question" class="mb-2">
              <br>
              <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                ...
                <div class="form-actions">
                  <b-button type="submit" variant="danger" >Post</b-button>
